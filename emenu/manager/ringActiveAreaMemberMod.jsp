...
<html>
<head>
<title>Edit latest recommend ringtone</title>
...
<script language="javascript">
   function checkInfo () {
      ...
      if(value==''){
         //alert("请输入新Ringtone code!");
         alert("Please input the latest <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> code!");
         fm.ringid.focus();
         return flag;
      }
      if (!checkstring('0123456789',value)) {
        // alert('新Ringtone code必须是数字!');
         alert("The latest <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> code must be a digital number!");
         fm.newringid.focus();
         return flag;
      }
      flag = true;
   ...
   function doSure () {
      ...
      if(fm.ringid.value == fm.newringid.value){
        // alert("新Ringtone code同原Ringtone code相同,请重新输入!");
         alert("The new <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> code is equal to the old <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> code,please re-enter!");
         fm.newringid.focus();
         return;
      }
          ...
          <table width="85%" cellspacing="1" cellpadding="2" border="0" class="table-style2">
            <tr>
              <td align="center" colspan=2  height=40>
               <font class="font"><b><img src="../../image/n-8.gif" width="8" height="8">Edit activity area <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%></b></font>
              </td>
            </tr>
            <tr>
             <td  align=right height=25 >&nbsp;&nbsp;Rank no</td>
            ...
            <tr>
             <td align=right height=25>&nbsp;&nbsp;Old <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> name</td>
