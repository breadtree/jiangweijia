...
<html>
<head>
<title>Batch blacklist subscriber file upload</title>
...
<%
        ...
        sysInfo.add(sysTime + operName + " Exception occurred in uploading the blacklist file! ");// 黑名单文件上载过程出现异常!
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occurred in uploading the blacklist file!");//黑名单文件上载过程出现错误!
        vet.add(e.getMessage());
        session.setAttribute("ERRORMESSAGE",vet);
%>
<form name="errorForm" method="post" action="error.jsp">
<input type="hidden" name="historyURL" value="blackupload.jsp">
</form>
<script language="javascript">
