...
<html>
<head>
<title>Edit IVR category ringtone</title>
          ...
          <table width="85%" cellspacing="1" cellpadding="2" border="0" class="table-style2">
            <tr>
              <td align="center" colspan=2  height=40>
               <font class="font"><b><img src="../../image/n-8.gif" width="8" height="8">Edit IVR category ringtone</b></font>
              </td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <td><input type="text" name="ringid"  value="<%= ringid %>" maxlength="20"  value="" class="input-style1" disabled ></td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <td><input type="text" name="newringid" value="<%= newringid %>" maxlength="20" class="input-style1" ><img  height="15" src="../image/query.gif" onMouseOver="this.style.cursor='hand'" onclick="javascript:queryInfo()"></td>
            </tr>
