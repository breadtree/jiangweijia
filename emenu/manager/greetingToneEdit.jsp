...
<%
    ...
    try {
            if (operID != null && purviewList.get("2-31") != null) {
...
<form name="inputForm" method="post" action="greetingToneEdit.jsp">
      ...
      <table width="98%" border="0" cellspacing="1" cellpadding="1" align="center" class="table-style4">
         <tr class="tr-ringlist">
		  ...
		  <td height="30" width="30">
                  <div align="center"><font color="#FFFFFF"><span title="Listen the Greeting Tone">Listen</span></font></div>
                </td>
                <td height="30" width="30">
                  <div align="center"><font color="#FFFFFF"><span title="Delete the Greeting Tone">Delete</span></font></div>
                </td>
                 <td height="30" width="30">
                  <div align="center"><font color="#FFFFFF"><span title="Edit the Greeting Tone">Edit</span></font></div>
                </td>
              </tr>
...
%>
        ...
        <td height="20">
          <div align="center"><font class="font-ring""><img src="../image/play.gif" alt="Try listen this Greeting Tone" onmouseover="this.style.cursor='hand'" onClick="javascript:tryListen('<%= (String)hash.get("ringid") %>','<%= (String)hash.get("ringlabel") %>','<%= (String)hash.get("ringauthor") %>')"></font></div>
        </td>
        <td height="20">
          <div align="center"><font class="font-ring"><img src="../image/delete.gif" alt="Delete" onMouseOver="this.style.cursor='hand'" onclick="javascript:delRing('<%= (String)hash.get("ringid") %>','<%= (String)hash.get("ringlibcode") %>','<%= (String)hash.get("ringlabel") %>')"></font></div>
        </td>
       <td height="20">
          <div align="center"><font class="font-ring"><img src="../image/edit.gif" alt="Edit" onmouseover="this.style.cursor='hand'" onclick="javascript:editRing('<%= (String)hash.get("ringid") %>','<%= (String)hash.get("ringlibcode") %>')"></font></div>
       </td>
        </tr>
<%
         }
...
<input type="hidden" name="historyURL" value="greetingToneEdit.jsp">
</form>
<script language="javascript">
