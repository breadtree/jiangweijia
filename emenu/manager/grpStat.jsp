...
<%
    ...
    try {
      ...
      else if (purviewList.get("11-5") == null) {
...
<%
 ...
 //change by wxq 2005.06.16 for version 3.16.01
   ...
   //change by wxq 2005.06.16 for version 3.16.01
 	    arraylist = mangroup.getGrpStat(map,resultList);
            //end
	    int thepage = 0 ;
        int pagecount = 0;
        int records = 20;
...
<html>
<head>
<title>Statistics on the total number of groups</title>
...
<form name="InputForm" method="post" action="grpStat.jsp">
...
<table border="0" width="90%" cellspacing="0" cellpadding="0" class="table-style2" height=hei align="center">
  <tr>
    <td valign="top" height="35">
	    ...
	    <tr>
          <td height="26"  align="center" class="text-title" >statistics on the total number of groups </td>
        </tr>
        <tr>
             <td width="15%" >Type of query:&nbsp;&nbsp;<input type="radio" name="checkflag" value="0" onclick="onCheckTime()">Statistics by day&nbsp;&nbsp;
  ...
  %>
     ...
     <table width="100%" border="0" cellspacing="1" cellpadding="2"  class="table-style2" id="<%= pageid %>" style="display:none" >
         <tr class="table-title1" height=26>
          ...
          <td width="80"  align="center"><span class="style1">Number of groups</span></td>
		  <td width="80"  align="center"><span class="style1">Times of new group additions</span></td>
          <td width="80"  align="center"><span class="style1">Times of group deletions</span></td>
         </tr>
         <%
   			if(size==0){
			%>
            ...
            for(int j=0;j<record;j++){
                ...
                out.print("<td align=center>"+(String)map.get("grpnum")+"</td>");
                out.print("<td align=center>"+(String)map.get("addgrpnum")+"</td>");
                out.print("<td align=center>"+(String)map.get("delgrpnum")+"</td>");
                out.print("</tr>");
      }
 %>
...
<%
        ...
        sysInfo.add(sysTime + operName + " Exception occurred in the statistics on the total number of groups");//集团总数统计过程出现异常
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occurred in the statistics on the total number of groups");//集团总数统计过程出现错误
        vet.add(e.getMessage());
        session.setAttribute("ERRORMESSAGE",vet);
%>
<form name="errorForm" method="post" action="error.jsp">
<input type="hidden" name="historyURL" value="grpStat.jsp">
</form>
<script language="javascript">
