...
<form name="inputForm" enctype="multipart/form-data" method="post" action="OBDFileUploadEnd.jsp">
...
<table border="0" cellspacing="0" cellpadding="0" height="100%" align="center" class="table-style2">
  <tr valign="center">
    <td>
      <table border="0" align="center" class="table-style2">
        <tr>
          <td colspan="2" align="center" class="text-title">OBD File Upload </td>
        </tr>
        <tr>
  ...
  <tr style="color: #0000FF">
    <td>2.Each line of the directory file is a subscriber number;</td>
  </tr>
  <tr style="color: #0000FF">
      <td>3.Please do not use the batch uploading function in the busy hour;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>  
