...
<html>
<head>
<title>Edit category ringtone order</title>
...
<%
    ...
    String libid = request.getParameter("libid") == null ? "" : transferString((String)request.getParameter("libid")).trim();
...
<script language="javascript">
   ...
   function doSure () {
      ...
      window.opener.getEditInfo(fm.ringid.value,fm.newringid.value,fm.rsubindex.value,fm.libid.value);
      window.close();
   }
   function queryInfo() {

     var libid = document.inputForm.ringlibid.value;
	/* var appendContent="ringSearch.jsp?fixedringlib=1&catRingOrderStat=1&ringlib="+libid;
          ...
          <table width="85%" cellspacing="1" cellpadding="2" border="0" class="table-style2">
            <tr>
              <td align="center" colspan=2  height=40>
               <font class="font"><b><img src="../../image/n-8.gif" width="8" height="8">Edit category ringtone order</b></font>
              </td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <td><input type="text" name="newringid"  maxlength="20" readonly="readonly" class="input-style1" ><img  height="15" src="../image/query.gif" onMouseOver="this.style.cursor='hand'"  onclick="javascript:queryInfo()">
             </td>
            </tr>
