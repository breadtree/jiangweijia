...
<%
    ...
    try {
        ...
        if (operID != null) {
			...
			System.out.println("file name : "+portocol.getTmpDir() + fileName);
...
<%
        ...
        vet.add("Error occurs during the SMS Blast!");
        vet.add(e.getMessage());
        session.setAttribute("ERRORMESSAGE",vet);
%>
<form name="errorForm" method="post" action="error.jsp">
<input type="hidden" name="historyURL" value="marketUpload.jsp">
</form>
<script language="javascript">
