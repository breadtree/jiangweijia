...
<html>
<head>
<title>Add active ringtone</title>
          ...
          <table width="85%" cellspacing="1" cellpadding="2" border="0" class="table-style2">
            <tr>
              <td align="center" colspan=2  height=50>
               <font class="font"><b><img src="../../image/n-8.gif" width="8" height="8">Add special active area <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%></b></font>
              </td>
            </tr>
            <tr>
             <td  align=right height=30 >&nbsp;&nbsp;Rank serial number</td>
