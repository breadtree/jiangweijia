...
<form name="inputForm" enctype="multipart/form-data" method="post" action="marketUploadEnd.jsp">
  ...
  <tr valign="center">
    <td>
      <table border="0" align="center" class="table-style2">
        <tr>
          <td colspan="2" align="center" class="text-title">Short message marketing activity</td>
        </tr>
        <tr>
