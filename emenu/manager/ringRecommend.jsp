...
<%
    ...
    try {
        ...
        if (operID != null && purviewList.get("2-7") != null) {
            ...
            if (op.equals("add")){
                optype = 1;
                title = "Add recommended ringtones";//增加推荐铃音
            }
            else if (op.equals("del")) {
                optype = 2;
                title = "Delete recommended ringtones";//删除推荐铃音
            }
            else if (op.equals("edit")) {
                optype = 3;
                title = "Modify recommended ringtones";//修改推荐铃音
            }
...
<input type="hidden" name="historyURL" value="ringRecommend.jsp">
...
<form name="inputForm" method="post" action="ringRecommend.jsp">
...
<table width="440" height="400" border="0" align="center" class="table-style2">
  ...
  <td>
        ...
        <tr >
          <td height="26" colspan="2" align="center" class="text-title" background="image/n-9.gif">Manage latest recommended <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%>s</td>
        </tr>
        <td align="center">
