  ...
  function login(ringid,action){
   ...
   function ringInfo (ringid, grouplabel, spindex)
   {
    ...
    <tr class="tr-ringlist">
        ...
        <td height="30" width="40">
          <div align="center"><font color="#FFFFFF"><span title="Price"><span title="<%=giftbag%> Price">Price(<%=majorcurrency%>)</span></font></div>
        </td>
...
<%}%>
       ...
       <td height="20" align="center" style="display:none"><img src="../image/info.gif" alt="View the detail of gift package" onmouseover="this.style.cursor='hand'" onclick="javascript:ringInfo('<%= (String)hash.get("ringid") %>',
