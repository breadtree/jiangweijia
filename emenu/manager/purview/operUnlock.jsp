...
<form name="view" method="post" action="operUnlockEnd.jsp">
<input type="hidden" name="operID" value="<%= operID %>">
<input type="hidden" name="operType" value="<%= opertype %>">
<input type="hidden" name="opname" value="<%= (String)map.get("OPERNAME") %>">
...
<table border="1" width="300" bordercolorlight="#77BEEE" bordercolordark="#ffffff" cellspacing="0" cellpadding="0" class="table-style5">
  ...
  <tr>
    <td width="33%" height="22" align="right" class="table-title5">Description:</td>
  ...
  <tr>
    <td colspan="2">
      <table width="100%" border="0" class="table-style5">
        <tr align="center">
          <td height="22"><input type="button" name="sure" value="Unlock" class="button-style1" onclick="javascript:onSubmit()"></td>
