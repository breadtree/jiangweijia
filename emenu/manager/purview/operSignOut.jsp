...
<%
    try {
        ...
        String pid = (String)request.getParameter("pid");
		 ...
		 System.out.println("****Service Key*****"+sysring.getSerkey());
		String self = (String)request.getParameter("selfID") == null ? "" : (String)request.getParameter("selfID");

        if (! self.equals(""))
	     { 
		   purview.signOut(self,sysring.getSerkey());
            
	    }
%>
<html>
<head>
<title>Sign Out operator</title>
...
<script language="javascript">
   ...
   // 页面提交
   function onSubmit () {
       document.view.selfID.value= <%= operID %>;
...
<form name="view" method="post" action="operSignOut.jsp">
