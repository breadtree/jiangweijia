    ...
    try {
        ...
        if (operID != null) {
            ...
            if (ringFile.getSize() < 8000)
                throw new Exception("Ringtone file size must be larger than 8K!");//铃音文件必须大于8KB!
            else {
...
<%
        ...
        sysInfo.add(sysTime + operName + " exception  occourred in the upload of ringtone!");// 铃音上载过程出现异常!
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occourred in the upload of ringtone!");
