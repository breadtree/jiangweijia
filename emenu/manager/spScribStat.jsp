...
<%
    ...
    try {
      ...
      else if (purviewList.get("4-5") == null  || (!purview.CheckOperatorRightAllSerno(session,"4-5"))) {
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="table-style2" height=500 align="center">
  <tr>
	...
	<tr >
          <td height="30" colspan=5 align="center" class="text-title"  background="image/n-9.gif">Query SP ringtone orders</td>
   </tr>
   <tr >
    ...
    <td align="center" valign="top">
      <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table-style2" >
        <tr  class="tr-ring">
		  ...
		  <td width="20%" height="24" align="center"><span class="style1">Number of ringtone downloads</span></td>
        <% //if(!(disLargess.equals("1"))){%>
          <td width="20%" height="24" align="center"><span class="style1">Number of ringtone presents</span></td>
        <%//}%>
		  <td width="20%" height="24" align="center"><span class="style1">Total charge (<%=majorcurrency%>)</span></td>
        </tr>
<%
        if(list!=null){
          float num1=0,num2=0,num3=0;String tVAL="";
		 ...
		 for (int i = thepage*15; i < thepage*15+15 && i<list.size(); i++) {
				...
				out.println("<td align=center>" + intbuytimes + "</td>");
                                tVAL = (String)map.get("buytimes");
                                tVAL = tVAL==null?"0":tVAL.trim().equals("")?"0":tVAL.trim();
                                num1+=intbuytimes;//Float.parseFloat(tVAL);
//			if(!(disLargess.equals("1")))
				out.println("<td align=center>"+(String)map.get("prestimes")+"</td>");
                                tVAL = (String)map.get("prestimes");
                                tVAL = tVAL==null?"0":tVAL.trim().equals("")?"0":tVAL.trim();
                                num2+=Float.parseFloat(tVAL);
				...
				if(strfee.length()==0)
					...
					out.println("<td align=center>"+strfee+"</td>");
                                  num3+=0;
                                       ...
                                       strfee = strfee==null?"0":strfee.trim().equals("")?"0":strfee.trim();
					//float fee = Float.parseFloat(strfee);
					out.println("<td align=center>"+displayFee(strfee)+"</td>");
                                        num3+=Float.parseFloat(displayFee(strfee));

				}
          		out.println("</tr>");
		  }
                  String value3="0.00";
                  value3=df.format(num3) ;
                  out.println("<tr>");
                  out.println("<td align=center colspan='2'>Total:</td>");
                  out.println("<td align=center >"+num1+"</td>");
                  out.println("<td align=center >"+num2+"</td>");
                  out.println("<td align=center >"+value3+"</td>");
                  out.println("</tr>");
