...
<%
	...
	try {
        ...
        //配置权限？？？？？
        if (operID != null && purviewList.get("1-14") != null) {
            ...
            if (op.equals("add")) {
                ...
                title = "Delete special list";
                 ...
                 optype = 3;
                 desc = operName + " add special list in batch";//批量增加特殊名单
...
<input type="hidden" name="historyURL" value="speciallist.jsp">
...
function toPage (page) {
   ...
   function searchRing () {
      ...
      if(sTmp!='' ){
         if(!checkstring('0123456789',sTmp)){
              alert('<%=user_number%> prefix must be in digit format, please input it again!');//User number前缀必须是数字,请重新输入!
              fm.usernumber.focus();
	      return
         }
      }
      if(sTmp =='' ){
        alert('Please input <%=user_number%> prefix!');//请输入User number前缀!
        fm.usernumber.focus();
        return
      }
      fm.page.value = 0;
   ...
   function checkInfo () {
      ...
      if(!isUserNumber(value,'<%=user_number%>')){//User number
            fm.special.focus();
            return false;
      }
   ...
   function batchadd() {
       var fm = document.inputForm;
       if(fm.tfile.value == ''){
         alert("Please select files in batch!");//请选择批量文件!
         fm.tfile.focus();
         return;
       }
  ...
  <tr valign="center">
    <td>
      <table width="100%" border="0" align="center" class="table-style2">
        <tr >
          <td height="26" colspan="3" align="center" class="text-title" background="image/n-9.gif">Management of special list</td>
        </tr>
        <tr>
          <td  width="100%" align="center" colspan="2">
    <table border="0" cellspacing="1" cellpadding="1" class="table-style2" width="100%" align="center">
    <tr>
        <td align="right" height="26" width="20%">&nbsp;Special list Number</td>
		<td width="33%" height="26"><input type="text" name="special" value="" maxlength="20" class="input-style1" style="width:120"></td>
          <td align="right" width="20%" height="26">
              <div id="tex">Restriction times</div></td>
		<td width="30%" height="26"><input type="text" name="limittimes" value="" maxlength="8" class="input-style1" style="width:80"></td>
    ...
    <tr>
          <td align="right">SCP type</td><td><select name="scplist" size="1" style="width:120px">
              <% out.print(optSCP); %>
             </select>
           </td>
      <td width="11%" align="right"><%=user_number%> prefix</td><td width="30%"><input type="text" name="usernumber" value="<%= sUserNumber %>" maxlength="30" class="input-style1" style="width:120" >
      </td>
    ...
    <tr>
      <td align="right" width="12%">Restriction type</td><td width="33%">
        <select name="flag" size="1" style="width:150px">
        <option value="1">Download times</option>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="table-style4">
         <tr class="tr-ringlist">
               <td height="30" width="10%">
                  <div align="center">Selection flag</div>
                </td>
                <td height="30" width="30%">
                  <div align="center"><%=user_number%></div>
                </td>
                <td height="30" width="30%">
                    <div align="center">Restriction times</div>
                </td>
                <td height="30" width="30%">
                    <div align="center">Restriction type</div>
                </td>
                <td height="30">
...
%>
        ...
        <td height="20">
          <div align="center"><font class="font-ring"><img src="../image/edit.gif" alt="Eidt" onMouseOver="this.style.cursor='hand'" onClick="javascript:editInfo('<%= (String)hash1.get("specialnum") %>','<%= (String)hash1.get("limittimes") %>','<%= (String)hash1.get("specialtype")%>')"></font></div>
        </td>
         </tr>
<%
         }
         ...
         %>
         <tr bgcolor="FFFFFF" >
           <td align="center" colspan="5" height="20" >There are no users that can meet the condition!</td>
         </tr>
        <%
        }
         else if(vet.size()>0){
         ...
         <tr bgcolor="FFFFFF" >
           <td align="center" colspan="5"  height="40"  width="100%">
              ...
              <tr>
               ...
               <td>&nbsp;&nbsp;&nbsp;&nbsp;<img src="button/del.gif" alt="Delete special users" onMouseOver="this.style.cursor='hand'" onClick="javascript:delInfo()" > </td>
              </tr>
              </table>
           </td>
         </tr>
...
<%
        ...
        Vector vet = new Vector();
        sysInfo.add(sysTime + operName + "It is abnormal during the special list management!");
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occurs during the special list management");
        vet.add(e.getMessage()+" ,invalid file format!");
