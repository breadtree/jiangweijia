...
<html>
<head>
<title>Add the latest recommended <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%>s</title>
...
<script language="javascript">
   function checkInfo () {
      ...
      if(value==''){
         alert("Please enter the <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> code!");//«Î ‰»ÎRingtone code
         fm.ringid.focus();
         return flag;
      }
      if (!checkstring('0123456789',value)) {
         alert('The <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> code must be a digital number!');//Ringtone code±ÿ–Î « ˝◊÷
         fm.ringid.focus();
         return flag;
      }
      var value = trim(fm.rsubindex.value);
      if(value==''){
         alert("Please enter the serial number of a <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%>!");//«Î ‰»Î¡Â“Ù–Ú∫≈
         fm.rsubindex.focus();
         return flag;
      }
      if (!checkstring('0123456789',value)) {
         alert('The <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> No. must be a digital number!');//¡Â“Ù–Ú∫≈±ÿ–Î « ˝◊÷
         fm.rsubindex.focus();
         return flag;
      }
            ...
            <tr>
              <td align="center" colspan=2  height=50>
               <font class="font"><b><img src="../../image/n-8.gif" width="8" height="8">
                 Add the latest recommended <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%>s</b></font>
              </td>
            </tr>
            <tr>
             <td  align=right height=30 >&nbsp;&nbsp;Queue number</td>
