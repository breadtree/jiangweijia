...
<script language="javascript">
   function userLogin() {
      if (document.inputForm.opername.value == '') {
         alert('Please enter your username!');//请输入用户名
         return;
      }
...
<script language="JavaScript">
	if(parent.frames.length>0)
		parent.document.all.main.style.height="420";
</script>
        ...
        <tr>
          <td colspan="2">
            <table border="0" width="100%" class="table-style2">
              <tr>
                <td width="50%" align="center"><img src="button/login.gif" onmouseover="this.style.cursor='hand'" onclick="javascript:userLogin()"></td>
