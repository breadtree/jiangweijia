...
<script language="javascript">
    function doClick (srcObj,idForm,ringlibid,pos,leaf) {
      ...
      if(leaf==1){
         parent.frames["ringMove"].document.inputForm.ringlibid1.value=ringlibid;
         parent.frames["ringMove"].document.inputForm.Pos1.value=pos;
         parent.frames["ringMove"].searchRing();
      }
      return;
   }
...
<table width="162" border="0" align="center" cellpadding="0" cellspacing="0" class="table-style2">
  ...
  <tr>
    <td width="100%" onclick="javascript:doClick(this,'0',503,'Default <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> library',1)" onmouseover="this.style.cursor='hand'"><img src="folder/midplus.gif"  >Default <%=zte.zxyw50.util.CrbtUtil.getConfig("ringdisplay","ringtone")%> library</td>
  </tr>
 <%}
...
<%
        ...
        vet.add("Error occurred in transferring system ringtones!");//系统铃音转移过程出现错误
