...
<%
    ...
    try {
     ...
     /* else if (purviewList.get("4-62") == null) {
...
<%
	  ...
	  String op = request.getParameter("op") == null ? "" : ((String)request.getParameter("op")).trim();
        ...
        map.put("endday",endday);
 	    ...
 	    arraylist = manstat.getRrbtSysUserOps(map);
        if(op.equals("bakdata")){
          ...
          String file_name = XlsNameGenerate.get_xls_filename(startday, endday, "rrbtsysPersonTime", stat_type);
...
<html>
<head>
<title>Caller CRBT System person-time statistics</title>
...
<form name="InputForm" method="post" action="rrbtCurOpUserStat.jsp">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="table-style2">
     <tr>
          <td height="26" colspan="2" align="center" class="text-title" >RRBT System person-time Statistics</td>
      </tr>
</table>
<br>
<br>
  ...
  <tr>
    <td valign="top" height="35">
        ...
        <tr>
             ...
             <td width="22%" align="right" ><span title="Type of query"> Type of query:</span></td>
             <td width="16%" > <input type="radio" name="checkflag" value="0" onClick="onCheckTime()"><span title="Statistics by day">by day</span></td>
...
<%
        ...
        sysInfo.add(sysTime + operName + "Exception occurred in Caller CRBT person-time statistics in the system!");//统人次统计过程出现异常!
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occurred in Caller CRBT person-time statistics in the system");//系统人次统计过程出现错误!
        vet.add(e.getMessage());
        session.setAttribute("ERRORMESSAGE",vet);
%>
<form name="errorForm" method="post" action="error.jsp">
<input type="hidden" name="historyURL" value="rrbtCurOpUserStat.jsp">
</form>
<script language="javascript">
