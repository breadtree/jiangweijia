  ...
  function login(ringid,action){
   ...
   function ringInfo (ringid, grouplabel, spindex) {
    ...
    <tr class="tr-ringlist">
        ...
        <td height="30" >
              <div align="center"><font color="#FFFFFF"><span title="Provider of <%=musicbox%>">SP</span></font></div>
        </td>
        ...
        <td height="30" width="40">
              <div align="center"><font color="#FFFFFF"><span title="Price of this <%=musicbox%>">Daily Price(<%=majorcurrency%>)</span></font></div>
        </td>
		<%}%>
        <td height="30" width="40">
              <div align="center"><font color="#FFFFFF"><span title="Price of this <%=musicbox%>"><%if(issupportmultipleprice == 1){%>Monthly <%}%> Price(<%=majorcurrency%>)</span></font></div>
        </td>
...
<%}%>
       ...
       <td height="20" align="center"><img src="../image/info.gif"   height='15'  width='15'  alt="Find music box detail info." onmouseover="this.style.cursor='hand'" onclick="javascript:ringInfo('<%= (String)hash.get("ringid") %>',
