...
<html>
<head>
<title>Special area for advertisement ringtone management</title>
...
<%
    ...
    try {
        ...
        if (operID != null && purviewList.get("2-18") != null) {
            ...
            if (op.equals("add")){
                optype = 1;
                //title = "增加广告专区铃音";
                  title ="Add special area for advertisement ringtone management";
            }
                ...
                //title = "删除广告专区铃音";
                title ="Delete special area for advertisement ringtone management";
            }
            if(optype>0){
...
//      fm.rsubindex.value = v_rsubindex[index];
   ...
   function delInfo () {
      ...
      if(index == -1){
        //  alert("请选择您删除的广告专区铃音");
          alert("Please select the special area  advertisement ringtone you want to delete");
          return;
      }
     fm.op.value = 'del';
     fm.submit();
...
<table width="440" height="400" border="0" align="center" class="table-style2">
  ...
  <td>
        ...
        <tr >
          <td height="26" colspan="2" align="center" class="text-title" background="image/n-9.gif">Ringtone management in the advertising area</td>
        </tr>
        <td align="center">
        ...
        <td height='100%'>
            ...
            <tr>
                <!--
             <td  style="color: #FF0000" colspan=2 height=30> &nbsp;&nbsp;Notes:"arrange serial number" is a digital number</td>
             -->
            </tr>
            <tr>
...
<%
        ...
        sysInfo.add(sysTime + operName + "Exception occourred in the management of advertisement ringtone!");//广告专区铃音管理过程出现异常!
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occourred in the management of advertisement ringtone!");//广告专区铃音管理过程出现错误!
