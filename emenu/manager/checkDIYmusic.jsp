...
<input type="hidden" name="historyURL" value="checkDIYmusic.jsp">
...
<form name="inputForm" method="post" action="checkDIYmusic.jsp">
...
%>
               ...
               <tr>
                 <td height="22" align="right"><span title="Ringtone group price(<%=minorcurrency%>)">Price</span></td>
