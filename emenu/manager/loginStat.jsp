...
<%
        ...
        sysInfo.add(sysTime + operName + " Exception occurred in the statistics on the website logins");//用户登录网站统计过程出现异常!
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occurred in the statistics on the website logins");//用户登录网站统计过程出现错误!
