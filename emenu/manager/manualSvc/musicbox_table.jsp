...
<script language="javascript">
  ...
  function login(ringid,action){
   ...
   function ringInfo (ringid) {
      document.URL ='sysringgrpdetail.jsp?grouptype=1&groupid=' + ringid;
   }
    ...
    <tr class="tr-ringlist">
        <td height="30" width="80">
          <div align="center"><font color="#FFFFFF"><span title="Code of <%=musicbox%>">Code</span></font></div>
        </td>
        <td height="30">
          <div align="center"><font color="#FFFFFF"><span title="Name of <%=musicbox%>">Name</span></font></div>
        </td>
        <td height="30" >
              <div align="center"><font color="#FFFFFF"><span title="<%=musicbox%> Provider">Provider</span></font></div>
        </td>
        <td height="30" >
              <div align="center"><font color="#FFFFFF"><span title="<%=musicbox%> Validity">Validity</span></font></div>
        </td>
        <td height="30" width="40">
              <div align="center"><font color="#FFFFFF"><span title="the number of ringtone in this <%=musicbox%>">Ringtons</span></font></div>
        </td>
        <td height="30" width="40">
          <div align="center"><font color="#FFFFFF"><span title="Price(<%=majorcurrency%>)">Price(<%=majorcurrency%>)</span></font></div>
        </td>
        <td height="30" width="40">
          <div align="center"><font color="#FFFFFF"><span title="The number of user order this <%=musicbox%>">Order number</span></font></div>
        </td>
        <td height="30" width="20">
        <div align="center"><font color="#FFFFFF"><span title="Order the <%=musicbox%> for user">Order</span></font></div>
        </td>
        <td height="30" width="20">
        <div align="center"><font color="#FFFFFF"><span title="<%=musicbox%> Information">Info.</span></font></div>
        </td>
    </tr>
    <%
      Map hash = null;
    ...
    <tr bgcolor="<%= count % 2 == 0 ?  "FFFFFF" : "E6ECFF"%>">
       ...
       <td height="20" align="center"><img src="../../image/buy.gif"  height='15'  width='15' alt="Order <%=musicbox%> to personal <%= ringdisplay %> library" onMouseOver="this.style.cursor='hand'"  onclick="javascript:collection('<%=(String)hash.get("ringid")%>','<%= (String)hash.get("ringname") %>')"></td>
       <td height="20" align="center"><img src="../../image/info.gif" height='15'  width='15' alt="View detail of the <%=musicbox%>" onmouseover="this.style.cursor='hand'" onclick="javascript:ringInfo('<%= (String)hash.get("ringid") %>')"></td>
    </tr>
    <% } %>
