...
<html>
<head>
<title>Upload the user name list file for orderring ring in batches</title>
...
<%
        ...
        sysInfo.add(sysTime + operName + " Exception occurred in uploadding the special name list for orderring ring!");
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Error occurred in uploadding the special name list for orderring ring!");
