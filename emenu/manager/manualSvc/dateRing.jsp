...
<html>
<head>
<title>Ringtone management on the basis of commemoration day</title>
  ...
  <tr valign="center">
    <td>
      <table border="0" align="center" class="table-style2" width=100% >
        <tr >
          <td height="26" colspan="2" align="center" class="text-title" background="../image/n-9.gif">Ringtone management on the basis of commemoration day</td>
        </tr>
        <%
