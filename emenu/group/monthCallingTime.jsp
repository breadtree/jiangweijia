        ...
        if (isgroup)
            ...
            if (op.equals("add")) {
               ...
               boolean isringgroup =request.getParameter("isringgroup") ==null?false:(request.getParameter("isringgroup").equals("1")?true:false);
                ...
                operDesc = "Nes add group month period " + ringdisplay;//新增集团月time period
                ...
                hash.put("setpri", "");
                result1 = SocketPortocol.send(pool, hash);
                operDesc = "Modify group month period " + ringdisplay;//修改集团月time period
...
//      }
      ...
      if(fee>0 && pform.oldcrid.value != pform.ringID.value){
           //if(!confirm("更改时间段"+ ringdisplay +"需要交纳"+ fee/100 + "元！\n您确认更改该时间段"+ ringdisplay +"吗？" ))
