  ...
  <tr valign="center">
    <td>
      <table border="0" align="center" class="table-style2">
        <tr>
          <td colspan="2" align="center" class="text-title">Operator log in</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="password" name="password" value="" maxlength="8" class="input-style1" onKeyPress="return onPassword(event)"></td>
        </tr>
        <tr>
          <td colspan="2">
            <table border="0" width="100%" class="table-style2">
              <tr>
                <td width="50%" align="center"><img src="../manager/button/login.gif" onmouseover="this.style.cursor='hand'" onclick="javascript:userLogin()"></td>
