...
{
   if(document.all.Calendar.length)
       document.all.Calendar[0].style.display="none";
    else
...
Frt=InputBox.getBoundingClientRect().top+InputBox.clientHeight;
   ...
   {
   Frl = document.getBoxObjectFor(InputBox).x-2;
   Frt=document.getBoxObjectFor(InputBox).y+InputBox.clientHeight;		  
   }
...
if ((Frt+Frh+Frs>Winh)&&(Frh+Frs<Winh))
  Frt=Winh-Frh-Frs;
if(document.all.Calendar.length){
    document.all.Calendar[0].style.display="";
    document.all.Calendar[0].style.left=Frl;
    document.all.Calendar[0].style.top=Frt;
}else{
...
Fmshow+="<td class=\"showtd\"><center><i18n:message key='UserMSG0054500' /></center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><i18n:message key='UserMSG0054501' /></center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><i18n:message key='UserMSG0054502' /></center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><i18n:message key='UserMSG0054503' /></center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><i18n:message key='UserMSG0054504' /></center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><i18n:message key='UserMSG0054505' /></center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><font color='#FF0000'><i18n:message key='UserMSG0054506' /></font></center></td>"+"\n";
Fmshow+="</tr>"+"\n";
...
Fmshow+="<td class=\"showtd\" title=\"<i18n:message key='UserMSG0054507' />"+GetTodayDate()+"\" style=\"cursor:hand\" onclick=\"SetTodayDate(window.document.all."+InputBox.name+")\">";
Fmshow+="<font color=red>Today:</font>"+GetTodayDate();
Fmshow+="</td>\n";
Fmshow+="<td class=\"showtd\">";
...
Fmshow+="</tr>\n";
if(document.all.Calendar.length){
    document.all.Calendar[0].innerHTML=Fmshow;
    document.all.Calendar[0].style.display="";
}else{
