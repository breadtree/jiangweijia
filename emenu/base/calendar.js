...
Fmshow+="<td class=\"showtd\"><center>Mon</center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center>Tue</center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center>Wed</center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center>Thu</center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center>Fri</center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center>Sat</center></td>"+"\n";
Fmshow+="<td class=\"showtd\"><center><font color='#FF0000'>Sun</font></center></td>"+"\n";
Fmshow+="</tr>"+"\n";
...
Fmshow+="<td class=\"showtd\" title=\"Today:"+GetTodayDate()+"\" style=\"cursor:hand\" onclick=\"SetTodayDate(window.document.all."+InputBox.name+")\">";
