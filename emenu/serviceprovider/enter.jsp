...
<script language="javascript">
   function userLogin() {
      if (document.inputForm.opername.value == '') {
         alert("Please enter your user name!");//请输入用户名
         return;
      }
        ...
        <tr>
          <td colspan="2">
            <table border="0" width="100%" class="table-style2">
              <tr>
                <td width="50%" align="center"><img src="./image/login.gif" onclick="javascript:userLogin()" onmouseover="this.style.cursor='hand'"></td>
                <td width="50%" align="center"><img src="./image/again.gif" onclick="javascript:document.inputForm.reset()" onmouseover="this.style.cursor='hand'"></td>
              </tr>
            </table>
          </td>
        </tr>
