...
<script language="javascript">
    function doClick (srcObj,idForm,ringlibid,pos,leaf) {
      ...
      if(leaf==1)
        parent.musicboxMemberEdit.document.URL = "musicboxMemberEdit.jsp?ringlibid=" + ringlibid+"&Pos="+pos;
      return;
   }
...
<%
        ...
        Vector vet = new Vector();
        sysInfo.add(sysTime + operName + "Exception occurred in managing ringtone sort!");
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Errors occurred in managing ringtone sort!");
...
<table border="1" width="100%" bordercolorlight="#77BEEE" bordercolordark="#ffffff" cellspacing="0" cellpadding="0" class="table-style5" height=400>
  <tr>
    <td>Errors occurred in managing ringtone sort:<%= e.toString() %></td>
  </tr>
</table>
<%
    }
