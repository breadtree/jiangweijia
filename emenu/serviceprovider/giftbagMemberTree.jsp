...
<script language="javascript">
    function doClick (srcObj,idForm,ringlibid,pos,leaf) {
      ...
      if(leaf==1)
        parent.giftbagMemberEdit.document.URL = "giftbagMemberEdit.jsp?ringlibid=" + ringlibid+"&Pos="+pos;
      return;
   }
...
<table width="162" border="0" cellspacing="0" cellpadding="0" class="table-style2" style="color: #0000FF">
  ...
  <tr>
	...
	<table width="158" border="0" align="center" cellpadding="2" cellspacing="2" class="table-style2">
	  ...
	  <tr>
    	<td width="100%" >Ringtone sort library</td>
  	</tr>
...
<%
        ...
        Vector vet = new Vector();
        sysInfo.add(sysTime + operName + " Exception occurred in managing ringtone sort library!");
        sysInfo.add(sysTime + operName + e.toString());
        vet.add("Errors occurred in managing ringtone sort library!");
...
<table border="1" width="100%" bordercolorlight="#77BEEE" bordercolordark="#ffffff" cellspacing="0" cellpadding="0" class="table-style5" height=400>
  <tr>
    <td>Errors occurred in managing ringtone sort library:<%= e.toString() %></td>
  </tr>
</table>
<%
    }
