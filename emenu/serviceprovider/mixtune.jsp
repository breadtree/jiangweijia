...
<%
    ...
    try {
      ...
      if (operID != null && purviewList.get("10-17") != null) {
...
function trim (str) {
  ...
  function queryInfo(i) {
     ...
     if(is_ie)
    {
       var result =  window.showModalDialog('ringSearch.jsp?mixtuneStat='+i,window,"scroll:yes;resizable:yes;status:no;dialogLeft:"+((screen.width-560)/2)+";dialogTop:"+((screen.height-700)/2)+";dialogHeight:700px;dialogWidth:600px");
     if(result){
       if(i==1)
	 ...
	 var result =  window.open('ringSearch1.jsp?mixtuneStat='+i,'mywin','left=20,top=20,width=600,height=550,toolbar=1,resizable=0,scrollbars=yes');
     }
     }
   ...
   function listenMix(){
     Listenmix = window.open('../manager/tryListenCom.jsp?ringpath=wav/tmp/<%=operName%>_mix.wav','Try','width=400, height=200');
   }
...
<!-- Title begin -->
		...
		<tr>
                  <td height="26" colspan="2" align="center" class="text-title" background="../manager/image/n-9.gif">Mix Tune</td>
		</tr>
            </table>
<!-- Title end -->
              <table width="100%" cellspacing="2" cellpadding="2" border="0" class="table-style2" align="center">
                <tr valign="top">
                  <td width="100%" align="center">
                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="table-style2">
                      <tr>
                  ...
                  <table width="98%" border="0" cellspacing="1" cellpadding="2" align="center" class="table-style4">
                     <tr class="tr-ringlist">
                      ...
                      <td height="20" width="160">
                        <div align="left"><font color="#FFFFFF">Ring name</font></div></td>
...
<!--  upload begin-->
            <tr>
              <td colspan="2" height="300" width="100%">
                <iframe width="172" height="100%" frameborder=0 src="ringUploadTree.jsp?spmix=spmix" name="ringUploadTree" scrolling="auto"></iframe>
                <iframe width="342" height="100%" scrolling="no" frameborder=0 src="springUpload.jsp?spmix=spmix" name="ringUpload"></iframe>
              </td>
            </tr>
  ...
  <%}%>
            ...
            <tr valign="top">
               <td width="100%" colspan="2">
                 <table width="100%" cellspacing="1" cellpadding="2" border="0" bgcolor="#E1F2FF" class="table-style2">
                   <tr>
